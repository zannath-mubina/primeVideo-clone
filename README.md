PrimeVideo-clone
A full-stack Amazon Prime Video clone built with React JS and TMDB API

The project allows users to browse popular, trending, and top-rated movies and TV shows, and watch their official trailers using data fetched from the TMDB API.
